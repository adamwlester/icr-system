...
namespace MeStreamNLX
{
    ...
    class MeStreamNLX
    {
        ...
        private static bool isMainLoopStarted = false;
        ...
        static void Main()
        {
            ...
            if (!(com_netComClient.AreWeConnected()))
            {
                if (com_netComClient.ConnectToServer(NETCOM_IP))
                {
                    ...
                    while (r2c_packLast[CharInd('C', r2c_id)] != r2c_packLast[CharInd('D', r2c_id)] && !doAbort) ;
                    ...
                    while (r2c_packLast[CharInd('M', r2c_id)] != r2c_packLast[CharInd('D', r2c_id)] && !doAbort) ;
                    // set flag
                    if (!doAbort)
                    {
                        isMovedToStart = true;
                    ...
                    while (com_netComClient.AreWeConnected() && !(isRecDone || doAbort)) ;
                    Console.WriteLine();
                }
        ...
        private static void DoWork_RunGUI(object sender, DoWorkEventArgs e)
        {
            ...
            //com_Matlab.Execute(@"dbstop in ICR_GUI at 2659");

            // Run ICR_GUI.m
            com_Matlab.Feval("ICR_GUI", 0, out result, do_debug);
