...
namespace ICR_Run
{
    ...
    class ICR_Run
    {
        ...
        static void Main()
        {
            ...
            if (!(com_netComClient.AreWeConnected()))
            {
                ...
                if (isMovedToStart && com_netComClient.AreWeConnected())
                {
                    ...
                    // Wait for robot to fishing over commands before sending
                    Thread.Sleep(100);
        ...
        public static void DoWork_RunGUI(object sender, DoWorkEventArgs e)
        {
            ...
            if (doDebugMat)
            {
                //com_Matlab.Execute(@"dbstop in ICR_GUI at 4665");
            }
        ...
        public static void PrintAction(string msg_str, long t1 = -1, long t2 = -1)
        {
