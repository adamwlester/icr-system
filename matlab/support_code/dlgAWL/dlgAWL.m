function QuestFig = dlgAWL(Question,Title,Btn1,Btn2,Btn3,Default,ScreenCenter,dlgType,doEditBox)
...
if ~doEditBox
    ...
    MsgTxtHeight= 500;
    MsgTxtWidth= max(diff(cell2mat(strfind(Question, newline)))) * get(BtnHandle{1},'FontSize');
...
IconYOffset = FigPos(4)-IconHeight-DefOffset;
...
if ~doEditBox
    ...
    editpos = [ ...
        MsgTxtXOffset, ...
        MsgTxtYOffset, ...
        FigPos(3) - MsgTxtXOffset, ...
        FigPos(4) - MsgTxtYOffset];
...
IconCMap(256,:)=get(QuestFig,'Color');
