...
%% ==========================MAIN FUNCTION==================================
    ...
    function[] = RunScript()
        ...
        function[] = MainLoop()
            ...
            D.DIR.ioImgPath = fullfile(D.DIR.ioTop,'Images\plot_images\wall_top_down.png');
            % i/o dirs
        ...
        function[] = SF_UI_Setup()
            ...
            % Read in image
            img = imread(D.DIR.ioImgPath, 'BackgroundColor', [1 1 1]);
        ...
        function [] = SF_Finish_Setup()
            ...
            %% Start recroding and set remaining vars
                    ...
                    if any(D.B.check_inbound_rew)
                        ...
                        if D.B.flag_rew_reset
                            ...
                            if inbndTim >= D.PAR.rewDel || ...
                                ...
                                % Check if this reward was not cued or cue
                                % was not sent and reward
                                if ~D.B.is_cued_rew || ...
                                        (D.B.is_cued_rew && ~D.B.flag_cue_sent)
                ...
                if any(~isnan(D.P.Rat.rad))
                    ...
                    if any(check_inbound)
                        ...
                        if ~D.B.flag_rew_reset
                            ...
                            % Check if this is a normal cue lap
                            if D.B.is_cued_rew && ~D.B.flag_cue_sent
                                do_cue = true;
                            end
                            
                            % For half cue check if rat missed reward
                            if D.PAR.cueFeed == 'Half' && ...
                                    D.C.missed_rew_cnt > 0
                                do_cue = true;
                                D.B.is_cued_rew = true;
                                % Reset missed reward count
                                D.C.missed_rew_cnt = 0;
                            end
