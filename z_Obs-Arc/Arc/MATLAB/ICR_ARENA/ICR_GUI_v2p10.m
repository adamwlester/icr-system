...
%% ==========================MAIN FUNCTION==================================
    ...
    function[] = RunScript()
        ...
        % Time
        D.PAR.fdPlsDur = 3000; % open time (ms)
                ...
                if (loop_tim >= D.PAR.polRate)
                    ...
                    if etime(clock, D.C.moveDel) > 2.5 &&  ~D.C.doneMove
                        ...
                        if D.PAR.sesCond ~= 'Manual_Training' %#ok<*STCMP>
                            ...
                            Mat2CS('M', D.UI.rewBnds(D.I.rot,1));
                        end
                        D.C.doneMove = true;
        ...
        % Run Disconnect_All() to exit script
        Disconnect_All();
        ...
        function[] = SF_UI_Setup()
            ...
            D.UI.btnStupDone = uicontrol('Style','push', ...
                'Parent', D.UI.panStup, ...
                'Enable', 'Off', ...
                'String','DONE', ...
                'Callback', {@BtnStupDone}, ...
                'UserData', 0, ...
                'Units','Normalized', ...
                'Position', pos, ...
                'BackgroundColor', D.UI.disabledCol, ...
        ...
        function[] = SF_NLX_Setup()
            ...
            set(D.UI.toggSnd, 'Enable', 'On', ...
                'ForegroundColor', D.UI.dfltTxtLightCol, ...
                'BackgroundColor', D.UI.enabledCol)
            set(D.UI.btnStupDone, 'Enable', 'On', ...
                'BackgroundColor', D.UI.enabledCol)
            drawnow;
        end
        ...
        function [] = SF_Evt_Proc()
            ...
            if evtNRecs > 0
                ...
                % Started
                if ismember(evtStr, D.NLX.rew_on_str)
                ...
                % Stopped
                if ismember(evtStr, D.NLX.rew_off_str)
                    % Change feeder plot color and marker size
                ...
                % Running
                if ismember(evtStr, D.NLX.bull_run_str)
                ...
                % Stopped
                if ismember(evtStr, D.NLX.bull_stop_str)
            ...
            if all(D.B.track_fd_reset) && all(~isnan(D.P.Rat.rad))
                ...
                if any(D.B.track_fd)
                    ...
                    if inbndTim >= D.PAR.rewDel
                        ...
                        if ...
                                (D.PAR.cueFeed == 'All' || ...
                                (D.PAR.cueFeed == 'Half' && D.B.cue_next))
                        ...
                        if D.PAR.cueFeed ~= 'All'
                            if D.PAR.cueFeed == 'Half' && D.B.cue_next
                                D.B.cue_next = false;
                            else
        ...
        function [] = SF_Reward_Reset_Check()
            ...
            if ...
                ...
                Mat2CS('R', D.UI.rewBnds(D.I.rot,1));
        ...
        % SETUP DONE
        function [] = BtnStupDone(~, ~, ~)
            
            % Disable button so only pressed once
            set(D.UI.btnStupDone, 'Enable', 'Off', ...
                'BackgroundColor', D.UI.disabledCol);
            ...
            %set(D.UI.btnStupDone, 'UserData', 1);
...
%             end
        ...
        function [] =  Save_Ses_Data()
            ...
            % Print coppied file
            Update_Console(sprintf('\rCopying Cheetah File...\rFile: %s\Directory: %s\rTime: %s\r', ...
                D.DIR.recFi, D.DIR.rec, datestr(now, 'HH:MM:SS')));
