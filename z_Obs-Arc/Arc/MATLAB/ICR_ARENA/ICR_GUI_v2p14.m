...
%% ==========================MAIN FUNCTION==================================
    ...
    function[] = RunScript()
        ...
        function [] = SF_Finish_Setup()
            ...
            D.PAR.feedBnds = [...
                rad2deg(D.PAR.feedDist - D.PAR.setPoint) - 10, ...
        ...
        function [] = SF_Rat_In_Check()
            ...
            if all(~isnan(D.P.Rat.rad))
                ...
                D.B.track_strqd = Check_Rad_Bnds(D.P.Rat.rad, D.UI.strQuadBnds);
        ...
        function [] = SF_VT_Proc(fld)
            ...
            if vtNRecs > 0
                ...
                exc_3 = ...
                    rad_diff_last > 0.8*D.PAR.feedDist &...
                    rad_diff_last < 0.9*(2 * pi);
                
                % Do not use exc_3 for rat or if more than 1 sec of unused
                % data
        ...
        function [] = SF_Rotation_Trig_Check()
            ...
            if get(D.UI.btnICR, 'UserData')
                ...
                D.B.track_rot = Check_Rad_Bnds(D.P.Rat.rad, D.UI.rotBndNext);
        ...
        function [] = SF_Reward_Feeder_Check()
            ...
            if D.PAR.sesCond ~= 'Manual_Training'
                if D.B.track_fd_reset && any(~isnan(D.P.Rat.rad))
                    
                    % Check if rat in feeder bounds
                    D.B.track_fd = Check_Rad_Bnds(D.P.Rat.rad, D.UI.rewBnds(D.I.rot,:));
        ...
        function [] = SF_Lap_Check()
            ...
            % Set patches
            set(D.UI.ptchLapBnds(D.B.track_lap), ...
                'FaceAlpha', 0);
            set(D.UI.ptchLapBnds(~D.B.track_lap), ...
                'FaceAlpha', 0.1);
            ...
            if all(D.B.track_lap);
                ...
                for i = [2,1]
                    ...
                    [~,h_inds]= histc(D.P.(f).vel_hist(ind, 1), bnd);
                    vel_roh = D.P.(f).vel_hist(ind, 2);
                    roh_avg = cell2mat(arrayfun(@(x) mean(vel_roh(h_inds==x)), ...
                        1:100, 'Uni', false));
                    roh_avg = [roh_avg, roh_avg(1)]; %#ok<AGROW>
                    
                    % Convert to cart
                    [x, y] = pol2cart(bnd, roh_avg);
                    x =  x.*D.PAR.R + D.PAR.XC;
                    y =  y.*D.PAR.R + D.PAR.YC;
        ...
        function [] = SF_Reward_Reset_Check()
            ...
            track_quad = Check_Rad_Bnds(D.P.Rat.rad, D.UI.rewRstBnds(D.I.rot,:));
            
            % If rat is in bounds
            if any(track_quad) && ~D.B.track_fd_reset
