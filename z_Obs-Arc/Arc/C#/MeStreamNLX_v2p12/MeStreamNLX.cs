...
namespace MeStreamNLX
{
    ...
    class MeStreamNLX
    {
        ...
        private static bool isRecDone = false;
        ...
        static void Main()
        {
            ...
            if (!(com_netComClient.AreWeConnected()))
            {
                ...
                if (!doAbort) PrintAction("[Main] RUNNING: Wait for Last Pack...");
                bool pass = false;
                do
                {
                ...
                if (!doAbort) PrintAction("[Main] FINISHED: Wait for Last Pack...");
        ...
        private static void DoWork_RunGUI(object sender, DoWorkEventArgs e)
        {
            ...
            if (doDebugMat)
            {
                ...
                com_Matlab.Execute(@"dbstop in ICR_GUI at 83");
            }
