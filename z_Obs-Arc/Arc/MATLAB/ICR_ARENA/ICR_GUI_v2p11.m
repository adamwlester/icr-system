...
%% ==========================MAIN FUNCTION==================================
    ...
    function[] = RunScript()
        ...
        function [] = SF_Finish_Setup()
            ...
            %% Start recroding and set poling vars
            D.C.moveDel = clock;
            D.C.doneMove = false;
            ...
            if all(D.B.track_fd_reset) && all(~isnan(D.P.Rat.rad))
                ...
                if any(D.B.track_fd)
                    ...
                    if inbndTim >= D.PAR.rewDel || ...
                           D.B.cue_next % or this was a cued lap
                        ...
                        if ...
                                D.PAR.cueFeed == 'None' || ... % never cued
                                D.PAR.cueFeed == 'Half' && ~D.B.cue_next || ... % no cue this lap
                                D.PAR.cueFeed == 'Half' && D.B.cue_next && ~D.B.cue_sent_to_cs || ... % cue was not sent
                                D.PAR.cueFeed == 'All' && ~D.B.cue_sent_to_cs % cue was not sent
        ...
        function [] = PopCond(~, ~, ~)
            ...
            % Change other buttons for rot cond and disable
            if D.PAR.sesCond == 'Rotation'
        ...
        function [] = BtnRec(~, ~, ~)
            ...
            if strcmp(get(D.UI.btnSesDone, 'Enable'), 'off') && ...
                    ~D.B.rec_done
                set(D.UI.btnSesDone, ...
                    'Enable', 'on', ...
                    'BackgroundColor', D.UI.enabledCol)
        ...
        function [] =  Save_Ses_Data()
            ...
            % Print coppied file
            Update_Console(sprintf('\rCopying Cheetah File...\rFile: %s\rDirectory: %s\rTime: %s\r', ...
