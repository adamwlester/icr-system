...
% ------------------------------NLX SETUP----------------------------------
    ...
    function[D] = SF_NLX_Setup(D)
        ...
        % Run ozone from arduino
        D.NLX.arduino_run_oz_cmd = [ ...
            '-SetDigitalIOportString ', ...
            D.NLX.DevName, ' ', ...
            D.NLX.port_out, ...
            ' "', ['100000','10'], '"'];
        ...
        if ...
            ...
            if ...
                ...
                if D.UI.sndair(6)
                    ...
                    % Set new ozone bound patch to visible
                ...
                if D.B.rat_rev
                    ...
                    if ...
                        ...
                        fprintf('\r\nAverse_ON:%s%3.2f_min\n', ...
                            repmat('_',1,8), ...
                            etime(D.T.ses_str_tim, D.T.avrs_str_tim)/60);
    ...
    function [D] = SF_Ozone_Trigger_Check(D)
        ...
        if ...
            ...
            if any(track_oz);
                ...
                % Turn on ozone
                % post NLX command
                NlxSendCommand(D.NLX.arduino_run_oz_cmd);
                % track timing
    ...
    function [] = RadSndAir(~, ~, ~)
        ...
        if updateRad
            ...
            if D.UI.sndair(4) == false
                ...
                set(D.UI.radSndAir(5:6), 'Value', 0);
            end
        end
...
% REC BUTTON
    function [] = BtnRec(~, ~, ~)
        ...
        if  D.B.rec
            ...
            if D.T.rec_str_tim == 0
                D.T.rec_str_tim = clock;
            end
            % save out time before stopping
...
% ---------------------------SAVE SESSION DATA-----------------------------
    function [] =  Save_Ses_Dat(D)
        ...
        % Add entries
        D.SS_Out_ICR.(D.PAR.ratLab).Include(rowInd) = true;
