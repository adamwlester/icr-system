...
void setup() {                
  ...
  SerialUSB.begin(0); //Start connection with Bluetooth
  SerialUSB.println("Bluetooth connection online");
}
...
void readFile(char *fileName) {
  ...
  //SerialUSB.println("Counting characters, be right back");
  ...
  for(int timeOut = 0 ; timeOut < 1000 ; timeOut++)
  {
    ...
    {
      SerialUSB.print(Serial.read()); //Take the character from OpenLog and push it to software serial TX
  ...
  //SerialUSB.print("Characters read: ");
  //SerialUSB.println(charactersRead);
