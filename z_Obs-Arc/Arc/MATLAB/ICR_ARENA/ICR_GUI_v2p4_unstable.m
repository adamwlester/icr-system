...
%% =========================== MAIN SCRIPT ================================
    ...
    function[] = RunScript()
        ...
        D.PAR.strQdDel = 1; % min time in start quad (sec)
...
% -------------------------------UI SETUP-----------------------------------
    ...
    function[] = SF_UI_Setup()
        ...
        D.UI.btnHaltRob = uicontrol('Style','push', ...
            'Parent',FigH, ...
            'String','HALT ROBOT', ...
            'Callback', {@BtnHaltRob}, ...
            'UserData', 0, ...
...
% HALT ROBOT
    function [] = BtnHaltRob(~, ~, ~)
        user_data = get(D.UI.btnHaltRob, 'UserData');
        user_data = double(~(logical(user_data)));
        if (user_data == 1)
        ...
        % Save user data
        set(D.UI.btnHaltRob, 'UserData', user_data);
    end
