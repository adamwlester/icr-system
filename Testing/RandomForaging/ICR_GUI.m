...
% ------------------------------MAIN RUN-----------------------------------
    function[] = Run()
        ...
        function [] = Var_Setup()
            ...
            D.UI.rfRad = 20;
            % pos occ bins
            D.UI.rfBins = round((D.UI.rfRad*2)/3);
        ...
        function[] = UI_Setup()
            ...
            set(D.UI.axH(2), ...
                'XLim', [0,D.UI.vtRes(1)],...
                'YLim', [0,D.UI.vtRes(1)]);
            imshow(ones(D.UI.vtRes(1),D.UI.vtRes(1))*0.5, 'Parent',D.UI.axH(2));
            set(FigH,'visible','on');
            ...
            % make mask
            [colNums, rowNums] = meshgrid(1:D.UI.vtRes(1), 1:D.UI.vtRes(1));
            D.UI.rfMask = (rowNums - ceil(D.UI.rfRad*D.UI.xCMcnv)).^2 ...
                + (colNums - ceil(D.UI.rfRad*D.UI.xCMcnv)).^2 <= ceil(D.UI.rfRad*D.UI.xCMcnv).^2;
            h_mask = imshow(ones(D.UI.vtRes(1),D.UI.vtRes(1)), 'Parent',D.UI.axH(3));
            set(h_mask, 'AlphaData', ~D.UI.rfMask);
