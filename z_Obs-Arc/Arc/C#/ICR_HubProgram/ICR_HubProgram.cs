...
namespace ICR_HubProgram
{

    class ICR_HubProgram
    {

        #region ---------TOP LEVEL VARS---------

        // To quit exit program smoothly
        private static bool isMAThanging = true;
        ...
        static void Main()
        {
            ...
            com_netComClient.SetCallbackFunctionVT(deligate_netComCallback, new ICR_HubProgram());
            ...
            var NETCOM_APP_ID = "ICR_HubProgram"; // string displayed in Cheetah when connected
            ...
            else PrintAction("[Main] !!ABORTED: Wait for AC Connect!!");
        ...
        private static void DoWork_RunGUI(object sender, DoWorkEventArgs e)
        {
            ...
            if (doDebugMat)
            {
                //com_Matlab.Execute(@"dbstop in ICR_GUI at 1906");
            }
