...
% -----------------------SELECT TT SOUND SOURCE--------------------------
    function ToggHearSourceTT(hObject, ~, ~)
        ...
        % Disable headphone
        Send_M2NLX('-SetAudioSource "AcqSystem1_Audio0" Left None');
        Send_M2NLX('-SetAudioSource "AcqSystem1_Audio0" Right None');
        ...
        if ~strcmp(ent_set, 'None')
            ...
            for z_chn = chan_changed
                ...
                msg_str = sprintf('%s %s %d %s', ...
                    dev_str, side_str{side_ind}, z_chn-1, state_str);
        ...
        switch set_case
            ...
            case 'TT_Track_Objects'
                ...
                if strcmp(setting_str, 'Enable')
                    ...
                    Safe_Set(D.UI.toggIncludeTT, 'Visible', 'on');
