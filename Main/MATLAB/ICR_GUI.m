    ...
    function[] = RunScript()
        ...
        function[] = SF_Run_Test_Setup()
            if isTestRun
                ...
                % Set cue condition
                D.SS_In_All.Cue_Condition(ratInd) = 'All';
                    ...
                    if any(check_inbound)
                        ...
                        if ~D.B.flag_rew_reset
                            ...
                            if D.B.is_cued_rew
                                ...
                                % Send CS command with pos and zone
                                pos_center = D.UI.rewSetpointRad(D.I.rot);
                                Mat2CS('R', pos_center, D.I.zone);
                                ...
                                pos_center = D.UI.rewSetpointRad(D.I.rot);
                                Mat2CS('R', pos_center, 0);
                                % Darken all zoneets zone patch
                                set(D.UI.ptchFdH(:, D.I.rot), ...
                                    'FaceAlpha', 0.75)
                            end
        ...
        function [] = SF_Reward_Check()
            ...
            if D.PAR.sesCond ~= 'Manual_Training'
                ...
                if any(~isnan(D.P.Rat.rad))
                    ...
                    % Track first reward crossing
                    if ~D.B.flag_rew_crossed
                        
                        % Check if rat within any zone bounds
                        check_inbound = ...
                            Check_Rad_Bnds(D.P.Rat.rad, ...
                            [D.UI.rewBnds(end,1,D.I.rot),D.UI.rewBnds(1,end,D.I.rot)]);
                        ...
                        if any(check_inbound)
                            ...
                            % Update reward info
                            missed_percent = ...
                                (1 - sum(D.C.missed_rew_cnt) / (sum([D.C.lap_cnt{:}])+1))*100;
                            infstr = [...
        ...
        function [] = BtnReward(~, ~, ~)
            ...
            Mat2CS('R', 0, D.I.zone(D.PAR.zoneRewDur == max(D.PAR.zoneRewDur)));
        ...
        function[] = Mat2CS(id, data1, data2)
            ...
            if strcmp(id, 'R')
                ...
                % if imediate reward
                if strcmp(id, 'R') && data1 == 0 && data2 == 0
                    % reward send time
                    D.T.rew_sent = clock;
                end
            end
