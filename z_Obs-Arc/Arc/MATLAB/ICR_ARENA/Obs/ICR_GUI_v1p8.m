...
% ------------------------------NLX SETUP----------------------------------
    ...
    function[D] = SF_NLX_Setup(D)
        ...
        % Ozone event command strings
        D.NLX.oz_cmd = '-PostEvent Post_Ozone_On 209 0';
        ...
        if ...
            ...
            if ...
                ...
                if ...
                    ...
                    % make sure different bound is used for cue and ozone
                    if D.I.cue_bnd_ind == D.I.oz_bnd_ind
                        while D.I.cue_bnd_ind == D.I.oz_bnd_ind
                            D.I.cue_bnd_ind = ceil(rand(1,1)*size(D.UI.ozcuBnds,1));
                        end
                    end
                    D.UI.cueBnd = ...
                    ...
                    % Set new cue bound patch to visible
...
% ------------------------REWARD RESET CHECK-------------------------------
    ...
    function [D] = SF_Reward_Reset_Check(D)
        ...
        if any(track_quad)
            ...
            cur_quad = find(track_quad == 1);
            
            % Set any current occupied and preceding quad to true
            D.B.track_rew_reset(1:cur_quad) = true;
...
% RAT SELECTION
    function [] = PopRat(~, ~, ~)
        ...
        if get(D.UI.popRat,'Value') ~= 1
            ...
            %             rng(D.PAR.sesNum)
            % Seed random number generator with current date serial number
            rng(now)
